...
<div class="container-fluid">
    ...
    <div class="pagetitle ">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Ajouter une réservation de chambre triple</li>
            </ol>
        </nav>
    </div>
    ...
    if (isset($_SESSION['reservation-triple-message-success-global']) && !empty($_SESSION['reservation-triple-message-success-global'])) {
    ?>
        <div class="alert alert-primary" style="color: white; background-color: #2653d4; text-align:center; border-color: snow;">
            <?= $_SESSION['reservation-triple-message-success-global'] ?>
        </div>
    <?php
    }
    ?>
    ...
    if (isset($_SESSION['reservation-triple-message-erreur-global']) && !empty($_SESSION['reservation-triple-message-erreur-global'])) {
    ?>
        <div class="alert alert-primary" style="color: white; background-color: #9f0808; text-align:center; border-color: snow;">
            <?= $_SESSION['reservation-triple-message-erreur-global'] ?>
        </div>
    <?php
    }
    ?>

    <form action="<?= PATH_PROJECT ?>administrateur/dashboard/traitement-reservation-triple" method="post" class="user" novalidate>
...
<?php
unset($_SESSION['erreurs-reservation'], $_SESSION['donnees-reservation'], $_SESSION['reservation-triple-message-success-global'], $_SESSION['reservation-triple-message-erreur-global']);
