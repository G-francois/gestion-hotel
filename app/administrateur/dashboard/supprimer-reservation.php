        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="./ajout-reservation.php">Ajouter une réservation</a>
                        <a class="collapse-item" href="./liste-reservations.php">Liste des réservations</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Personnaliser:</h6>
                        <a class="collapse-item" href="../Repas/ajout-repas.php">Ajouter un repas</a>
                        <a class="collapse-item" href="../Repas/liste-repas.php">Listes des repas</a>
                    </div>
                </div>
            </li>
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; SOUS LES COCOTIERS</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
