...
if (isset($_POST['enregistrer'])) {
    ...
    if (empty($erreurs)) {
        ...
        // Appeler la fonction pour obtenir un numéro de chambre disponible de type "triple"
        ...
        if (!empty($numChambreDisponible)) {
            ...
            // Aucune chambre disponible de type "triple"
...
$_SESSION['reservation-triple-message-erreur-global'] = $message_erreur_global;
$_SESSION['reservation-triple-message-success-global'] = $message_success_global;
header('location: ' . PATH_PROJECT . 'administrateur/dashboard/reservation-triple');
