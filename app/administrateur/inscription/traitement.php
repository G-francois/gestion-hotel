...
if (empty($erreurs)) {
    ...
    $requette = 'INSERT INTO utilisateur (nom, prenom, sexe, email, telephone, nom_utilisateur, profil, mot_passe) VALUES (:nom, :prenom, :sexe, :email, :telephone, :nom_utilisateur, :Administrateur, :mot_passe)';
    ...
    header('location: ' . PATH_PROJECT . 'administrateur/inscription/');
}
