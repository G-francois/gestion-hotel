...
$donnees["Administrateur"] = "Administrateur";

if (empty($erreurs)) {
    $db = connect_db();

    // Ecriture de la requête
    $requette = 'INSERT INTO utilisateur (nom, prenom, sexe, date_naissance, email, nom_utilisateur, profile, mot_passe) VALUES (:nom, :prenom, :sexe, :date_naissance, :email, :nom_utilisateur, :Administrateur, :mot_passe);';
    ...
    header('location: /soutenance/administrateur/inscription/');
}
