  ...
  <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
    <div class="row">
      <div class="col-lg-8">
        ...
        <div class="btns">
          <a href="<?= PATH_PROJECT . 'client/chambres/reservations' ?>" class="btn-book animated fadeInUp scrollto">Faire une Réservation</a>
        </div>
          ...
          ?>
              <!-- <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="member" data-aos="zoom-in" data-aos-delay="100">
                  <img width="100%" height="280" src="<?= $chambre['photos'] == 'Aucune_image' ? PATH_PROJECT . 'public/images/default_chambre.jpeg' : $chambre['photos'] ?>" class=" zoom-effect" alt="Chambre Image" />
                  <div class="member-info">
                    <div class="member-info-content">
                      <h4>Chambre <?php echo $chambre['num_chambre']; ?> : <?php echo $chambre['lib_typ']; ?> </h4>
                  ...
                  <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                      <div style="display: flex; align-items: center; justify-content: space-between;">
                        <p class="card-text" style="color:black; margin-bottom: 0rem;"> Chambre <?php echo $chambre['num_chambre']; ?></p>
                        <!-- <a href="<?= PATH_PROJECT . 'client/chambres/details_chambre/' . $chambre['num_chambre'] ?>">Détails</a> -->

                        <!-- Button Détails modal -->
                        <p style="margin-bottom: 0rem;" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detailsModal-<?php echo $chambre['num_chambre']; ?>" data-num-chambre="<?php echo $chambre['num_chambre']; ?>">
                          Détails
                        </p>
              ...
              <!-- Modal  Détails-->
              <div class="modal fade" id="detailsModal-<?php echo $chambre['num_chambre']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
