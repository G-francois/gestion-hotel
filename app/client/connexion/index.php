							...
							<div class="col-lg-6">
								<div class="p-5">
									...
									if (isset($_SESSION['connexion-erreurs']) && !empty($_SESSION['connexion-erreurs'])) {
										?>
										<div class="alert alert-primary"
											 style="color: white; background-color: #b91000; border-color: #b91000; text-align:center;">
									...
									<form action="<?= PATH_PROJECT ?>client/connexion/traitement" method="post"
										...
										<div class="form-group">
											...
											<input type="text" name="email-nom-utilisateur" id="inscription-email"
												   class="form-control"
												   placeholder="Entrer votre adresse email ou nom d'utilisateur"
												   value="<?php if (isset($donnees["email-nom-utilisateur"]) && !empty($donnees["email-nom-utilisateur"])) {
											...
											<div class="form-group">
												...
												<input type="password" name="mot-passe" id="inscription-mot-passe"
													   ...
													   value="<?php if (isset($donnees["mot-passe"]) && !empty($donnees["mot-passe"])) {
