    ...
    <header id="header" class="fixed-top d-flex align-items-cente">
      <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
        <h1 class="logo me-auto me-lg-0">
          <a href="<?= '/' . GESTION_HOTEL ?>/client/site/home">Sous les Cocotiers</a>
        </h1>
      ...
      <main>
        <div class="container mt-5">
          ...
          <section class="section error-404 d-flex flex-column align-items-center justify-content-center">
            ...
            <a class="btn" href="<?= '/' . GESTION_HOTEL ?>/client/inscription/index" style="color:#d9ba85;">Retourner à l'inscription</a>
            <img src="<?= '/' . GESTION_HOTEL ?>/public/images/not-found.svg" class="img-fluid py-5" style="width: 360px;" alt="Page Not Found">
          </section>
