      ...
      <main>
        <div class="container mt-5">
          ...
          <section class="section error-404 d-flex flex-column align-items-center justify-content-center">
            <h1>Oups</h1>
            <h2>Le lien de validation est expirée.</h2>
            <a class="btn" href="<?= PATH_PROJECT ?>client/inscription/index" style="color:#d9ba85;">Retourner à l'inscription</a>
            <i class="bi bi-link-45deg" style="color: red;" alt="Page Not Found"></i>

            <a href="<?= PATH_PROJECT ?>client/inscription/renvoyer_mail_validation" class="button">Renvoyer l'e-mail de validation</a>
          </section>
