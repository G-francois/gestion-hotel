                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="<?= PATH_PROJECT ?>client/inscription">Créez un compte !</a>
                                </div>
                                <div class="text-center">
                                    <a class="small" href="<?= PATH_PROJECT ?>client/connexion">Vous avez déjà un compte ? Connectez-vous!</a>
                                </div>
                            </div>
                        </div>
                    </div>
