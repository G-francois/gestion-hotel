        ...
        <ul>
          ...
          <li class="nav-item">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <h5 class="ml-2" style="color: white;"><?= isset($_SESSION['utilisateur_connecter_client']) ?  $_SESSION['utilisateur_connecter_client']['nom_utilisateur'] : 'Pseudo' ?></h5>
            </a>
          ...
          <div class="card">
            <div class="card-body">
              <form action="<?= PATH_PROJECT ?>client/profil/traitement_edit_profil" method="post" enctype="multipart/form-data">
                ...
                ?>
                  <div class="alert alert-primary" style="color: white; background-color: #364e46; text-align:center; border-color: snow;">
                    <?= $_SESSION['success'] ?>
                  </div>
                <?php
                }
                ...
                <div>
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="nom" type="text" class="form-control <?= isset($_SESSION['erreurs']['nom']) ? 'is-invalid' : '' ?>" id="Name" value="<?= isset($_SESSION['utilisateur_connecter_client']) ?  $_SESSION['utilisateur_connecter_client']['nom'] : 'Nom' ?>">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="prenom" type="text" class="form-control <?= isset($_SESSION['erreurs']['prenom']) ? 'is-invalid' : '' ?>" id="Name1" value="<?= isset($_SESSION['utilisateur_connecter_client']) ?  $_SESSION['utilisateur_connecter_client']['prenom'] : 'Prenom' ?>">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="nom_utilisateur" type="text" class="form-control <?= isset($_SESSION['erreurs']['nom_utilisateur']) ? 'is-invalid' : '' ?>" id="user" value="<?= isset($_SESSION['utilisateur_connecter_client']) ?  $_SESSION['utilisateur_connecter_client']['nom_utilisateur'] : 'Nom utilisateur' ?>">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="telephone" type="text" class="form-control <?= isset($_SESSION['erreurs']['telephone']) ? 'is-invalid' : '' ?>" id="Phone" value="<?= isset($_SESSION['utilisateur_connecter_client']) ?  $_SESSION['utilisateur_connecter_client']['telephone'] : 'Téléphone' ?>">
