                    ...
                    <div class="col-md-6">
                        ...
                        <div>
                            <div style="display: flex">
                                ...
                                <p style="margin-left: 2rem">
                                    <i class="bi bi-house"></i>35.000F/nuit
                                </p>
                            </div>
                        </div>
                        <div>
...
<!-- <script>
    // Fonction pour afficher/cacher les champs d'accompagnateurs en fonction du nombre sélectionné
    function toggleAccompagnateursFields() {
        ...
        var accompagnateursFields = document.getElementById("accompagnateurs-fields");

        if (nombreAccompagnateurs > 0) {
            accompagnateursFields.style.display = "block";
        } else {
            accompagnateursFields.style.display = "none";
        }
    }
</script> -->
