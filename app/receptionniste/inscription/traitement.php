...
$donnees ["Receptionniste"] = "Receptionniste";
...
if (empty($erreurs)) {
    ...
    $requette = 'INSERT INTO utilisateur (nom, prenom, sexe, date_naissance, email, nom_utilisateur, profile, mot_passe) VALUES (:nom, :prenom, :sexe, :date_naissance, :email, :nom_utilisateur, :Receptionniste, :mot_passe);';
    ...
    $resultat = $inserer_utilisateur->execute([
        ...
        'email' => $donnees["email"],
        'Receptionniste' => $donnees["Receptionniste"],
    ...
    header('location: /soutenance/receptionniste/inscription/');
}
